...
let productsDOM = document.querySelector("#pantalonesList")
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 mt-5">
                <div class="product-grid">
                    <div class="product-image">
                        ...
                        <button data-id="${product.id}" class="add-to-cart" href="#">Añadir al carrito</button>
                    </div>
    ...
    addCartItem(item) {
        ...
        <img src="${item.image}" alt="">
            <div class="pushbar__text">
                ...
                <a href="#" class="pushbar__delete text-decoration-none text-light" data-id=${item.id}>Eliminar</a>
             
                <select class="form-control-field" id="size">
                    <option value="#">TALLA CH</option>
